                  ...
                  <div class="container px-lg-5">
                     <div class="row g-5 align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                              <h1 class="text-white mb-4 animated slideInDown">Catatan Keuangan Pribadi</h1>
                              <p class="text-white pb-3 animated slideInDown">Membantu pengguna mengelola dan melacak keuangan pribadi mereka.</p>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded text-center p-4">
                            ...
                            <p class="m-0">Memberikan pengguna formulir untuk menambahkan transaksi baru dengan memasukkan informasi seperti tanggal, deskripsi, jumlah, dan jenis transaksi (pemasukan/pengeluaran).</p>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded text-center p-4">
                            ...
                            <p class="m-0">Menyajikan informasi penting seperti saldo, total pemasukan, dan total pengeluaran secara singkat.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded text-center p-4">
                            <i class="fa fa-3x fa-laptop-code text-primary mb-4"></i>
                            <h5 class="mb-3">Manajemen Kategori</h5>
                            <p class="m-0">Memungkinkan pengguna untuk mengelola kategori transaksi, seperti menambah, mengedit, atau menghapus kategori tertentu. Kategori digunakan untuk mengelompokkan dan menganalisis transaksi.</p>
                        </div>
                    </div>
                </div>
            </div>
